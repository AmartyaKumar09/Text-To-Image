...
st.markdown("# :orange[Image Generator]")
...
def configure_sidebar() -> None:
    ...
    with st.sidebar:
        with st.form("my_form"):
            st.info("**Customize below**", icon="👇")
            with st.expander(":grey[**Refine your output here**]"):
            ...
            prompt = st.text_area(
                ":orange[**Type your text to generate an image**]",
                value="An astronaut riding a rainbow unicorn, cinematic, dramatic")
            negative_prompt = st.text_area(":orange[**Type what you don't want in the image 🙅🏽‍♂️**]",
        ...
        st.markdown(
            ...
            LinkedIn → [Amartya Kumar](https://www.linkedin.com/in/amartya-kumar-727754230/)
